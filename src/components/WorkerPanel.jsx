...
import { Cpu, Activity, TrendingUp, Clock, CheckCircle, XCircle } from 'lucide-react';
    ...
    <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {workers.map(worker => (
            <div key={worker.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-lg transition-shadow duration-200">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-3">
                  <div className={`w-3 h-3 rounded-full ${worker.status === 'busy' ? 'bg-green-500 animate-pulse' : 'bg-gray-400'}`}></div>
                  <div>
              ...
              <div className="space-y-3">
                <div>
                  <div className="flex items-center justify-between text-sm mb-1">
                    <span className="text-gray-600 flex items-center"><Activity className="w-4 h-4 mr-1" /> Load</span>
